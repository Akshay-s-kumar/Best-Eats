...
export const HeadLine = () => {
  return (
    <div className='max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6'>
        ...
        <div className='rounded-xl relative'>
            <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
                <p className='font-bold text-2xl px-2 pt-4'>Exquisite Dining Awaits</p>
                <p className='px-2'>Discover Our Delectable Menu</p>
                <button className='border-white bg-white text-black mx-2 absolute bottom-4 font-semibold'>Explore now</button>
            </div>
        ...
        <div className='rounded-xl relative'>
            <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
                <p className='font-bold text-2xl px-2 pt-4'>Reserve Your Table Today!</p>
                <p className='px-2'>Explore Our Menu Today</p>
                <button className='border-white bg-white text-black mx-2 absolute bottom-4 font-semibold'>Explore now</button>
            </div>
